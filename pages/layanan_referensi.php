...
<head>
    <meta charset="utf-8">
    <title>Layanan Referensi SMP N 10 Surakarta</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
						<a href="pages.php" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
						<div class="dropdown-menu m-0">
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Layanan Referensi</h1>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-4 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase">Layanan Referensi</h5>
                <h1 class="mb-0">Apa Saja Layanan Referensi yang Ada di Perpustakaan SMPN 10 SURAKARTA</h1>
            </div>
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.6s">
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <img class="img-fluid rounded" src="img/ensiklopedia.JPEG" style="width: 60px; height: 60px;" >
                        <div class="ps-4">
                            <h4 class="text-primary mb-1">Ensiklopedia</h4>
                        </div>
                    </div>
                    <div class="pt-4 pb-5 px-5">
                    Ensiklopedia adalah karya rujukan yang berisi keterangan atau uraian tentang berbagai hal dalam bidang ilmu pengetahuan, biasanya disusun menurut abjad.
                    </div>
                </div>
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <img class="img-fluid rounded" src="img/kamus.JPEG" style="width: 60px; height: 60px;" >
                        <div class="ps-4">
                            <h4 class="text-primary mb-1">Kamus</h4>
                        </div>
                    </div>
                    <div class="pt-4 pb-5 px-5">
                    Kamus adalah sejenis buku rujukan yang menerangkan makna katakata. Berfungsi untuk membantu seseorang mengenal perkataan baru
                    </div>
                </div>
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <img class="img-fluid rounded" src="img/biografi.JPEG" style="width: 60px; height: 60px;" >
                        <div class="ps-4">
                            <h4 class="text-primary mb-1">Biografi</h4>
                        </div>
                    </div>
                    <div class="pt-4 pb-5 px-5">
                    Biografi adalah koleksi yang memuat informasi penting tentang kehidupan seseorang, mulai dari kelahirannya, hal-hal yang dilakukannya semasa hidup yang berguna bagi orang lain dan masyarakat, hingga kematiannya.
                    </div>
                </div>
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <img class="img-fluid rounded" src="img/atlas.JPG" style="width: 60px; height: 60px;" >
                        <div class="ps-4">
                            <h4 class="text-primary mb-1">Atlas</h4>
                        </div>
                    </div>
                    <div class="pt-4 pb-5 px-5">
